...
export const predict = async (
    ...
    try {
        ...
        const response = await fetch("https://two5sp-energyinbuildings.onrender.com/predict", {
            method: "POST",
            headers: {
...
export const predictAll = async (
    ...
    try {
        ...
        const response = await fetch("https://two5sp-energyinbuildings.onrender.com/predict_all", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
